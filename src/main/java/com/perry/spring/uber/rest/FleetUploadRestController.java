package com.perry.spring.uber.rest;
...
@RestController
public class FleetUploadRestController {
    private LocationService locationService;

    @Autowired
    public FleetUploadRestController(LocationService locationService) {
        this.locationService = locationService;
    }

    @RequestMapping(value = "/fleet", method = RequestMethod.POST)
    @ResponseStatus(HttpStatus.CREATED)
    public void upload(@RequestBody List<Location> locatons){
        this.locationService.saveCarLocation((locatons));
    }
